    ...
    function()
    {
        $( '#find-selection-in-article-text' ).click(        
            function()
            {
                ...
                // send to find input.
                CONTEXT_TEXT.send_text_to_find_input( selected_text );
                
                CONTEXT_TEXT.log_message( "In document.ready( button - #find-mention-in-article-text ) - match text : " + selected_text );
            }
        )
    }
); //-- END document.ready( button - #find-mention-in-article-text ) --//
