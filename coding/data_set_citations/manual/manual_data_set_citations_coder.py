                    ...
                    if ( is_ok_to_process == True ):
                        ...
                        if ( current_article_data is not None ):
                            ...
                            if ( citation_data is not None ):
                                ...
                                json_article_data_note.content_description = "{} Data Store JSON (likely from manual coding of citations via data_set-citations-code view) - DataSetCitationData: {}".format( self.CONFIG_APPLICATION, citation_data )
