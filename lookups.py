...
def output_debug( message_IN, method_IN = "", indent_with_IN = "", logger_name_IN = "" ):
    ...
    if ( message_IN ):
        ...
        if ( DEBUG == True ):
            ...
            # got a logger name?
            my_logger_name = "context_data.lookups"
...
@register( "datasets" )
class DataSetLookup( context_text.lookups.LookupParent ):
    ...
    def get_query( self, q, request ):
        ...
        if ( query_set_OUT is None ):
            ...
            query_set_OUT = self.my_class.objects.filter( Q( name__icontains = q )
