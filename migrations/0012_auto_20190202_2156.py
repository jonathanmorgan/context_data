...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('sourcenet_datasets', '0011_datasetcitationdata_work_log'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='publication',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='sourcenet.Article'),
        ),
        migrations.AddField(
            model_name='datasetmention',
            name='tags',
